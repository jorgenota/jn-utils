 ...
 * can be set individually on every {@link SqsMessageHandler}.
 * The default policy is {@code NO_REDRIVE} because it is the safest way to avoid poison messages and have
