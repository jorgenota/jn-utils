...
package com.jorgenota.utils.aws.sqs.listener.annotation;

import com.jorgenota.utils.aws.sqs.listener.SqsMessageDeletionPolicy;
 ...
 * <li>{@link Acknowledgment} to be able to acknowledge the reception
 * of a message an trigger the deletion of it. This argument is only available when using the deletion policy
 * {@link com.jorgenota.utils.aws.sqs.listener.SqsMessageDeletionPolicy#NEVER}.</li>
 * </ul>
 * <p>Additionally a deletion policy can be chosen to define when a message must be deleted once the listener method
 * has been called. To get an overview of the available deletion policies read the {@link com.jorgenota.utils.aws.sqs.listener.SqsMessageDeletionPolicy} documentation.</p>
